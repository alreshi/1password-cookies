...
- Publishing others’ private information (including session cookies, tokens, or
  1Password item values) without explicit permission
...
via the contact method on their GitHub profile, or through a private GitHub
Security Advisory if secrets are involved.
...
aggression toward individuals or groups of people.
